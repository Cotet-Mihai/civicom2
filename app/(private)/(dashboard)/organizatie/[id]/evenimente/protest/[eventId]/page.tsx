...
import { ProtestStatsHeader } from '@/app/(private)/(dashboard)/panou/evenimente/protest/[id]/_components/ProtestStatsHeader'
import { StatsKpiBanner } from '@/app/(private)/(dashboard)/panou/evenimente/protest/[id]/_components/StatsKpiBanner'
