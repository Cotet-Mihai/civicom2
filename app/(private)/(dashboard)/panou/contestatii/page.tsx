...
export const metadata: Metadata = { title: 'Contestațiile mele — CIVICOM' }
      ...
      <div className="px-4 lg:px-8 py-8 pb-16 space-y-10">
        ...
        <div className="flex flex-col gap-2 border-b border-border/50 pb-6">
          <h1 className="font-heading text-3xl font-black uppercase tracking-tighter text-foreground md:text-4xl">
            Contestațiile <span className="text-primary">Mele</span>
          </h1>
          <p className="text-base text-muted-foreground">
            Urmărește statusul contestațiilor depuse pentru evenimentele respinse.
          </p>
        </div>
            ...
            {appeals.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Nu ai depus nicio contestație până acum.
                </p>
              </div>
            ) : (
