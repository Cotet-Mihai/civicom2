...
import { ArrowLeft, ExternalLink, TreePine } from 'lucide-react'
...
type Props = { data: CommunityPhysicalStatsData; backHref: string }

export function OutdoorStatsHeader({ data, backHref }: Props) {
  return (
