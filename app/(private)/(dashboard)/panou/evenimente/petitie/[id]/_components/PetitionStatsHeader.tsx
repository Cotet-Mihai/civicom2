...
type Props = { data: PetitionStatsData; backHref: string }

export function PetitionStatsHeader({ data, backHref }: Props) {
  return (
    <div className="space-y-4 border-b border-border/50 pb-6">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/evenimente/petitie/${data.id}`} className={buttonVariants({ variant: 'outline' }) + ' gap-1.5 text-xs'}>
