  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLButtonElement>) => {
    switch (e.key) {
      case "ArrowRight": case "ArrowDown":
        e.preventDefault(); if (myIdx !== -1 && focusNext) focusNext(myIdx); break
      case "ArrowLeft": case "ArrowUp":
        e.preventDefault(); if (myIdx !== -1 && focusPrev) focusPrev(myIdx); break
      case "Home": e.preventDefault(); if (focusFirst) focusFirst(); break
      case "End": e.preventDefault(); if (focusLast) focusLast(); break
